...
const (
	Sync_Replicate_FullMethodName = "/localfirst.sync.v1.Sync/Replicate"
)
...
type SyncClient interface {
	Replicate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Frame, Frame], error)
}
...
func (c *syncClient) Replicate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Frame, Frame], error) {
...
type Sync_ReplicateClient = grpc.BidiStreamingClient[Frame, Frame]
...
type SyncServer interface {
	Replicate(grpc.BidiStreamingServer[Frame, Frame]) error
...
func (UnimplementedSyncServer) Replicate(grpc.BidiStreamingServer[Frame, Frame]) error {
...
func _Sync_Replicate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SyncServer).Replicate(&grpc.GenericServerStream[Frame, Frame]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Sync_ReplicateServer = grpc.BidiStreamingServer[Frame, Frame]

// Sync_ServiceDesc is the grpc.ServiceDesc for Sync service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Sync_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "localfirst.sync.v1.Sync",
